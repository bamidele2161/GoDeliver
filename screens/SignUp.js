    ...
    <View style={styles.input_div}>
        ...
        >
            <View style={styles.inputField}>
                <Icon name='user' color='#818181' size={22} />
                <TextInput placeholder='First Name' style={styles.input} placeholderTextColor='#818181'/>
            </View>
            <View style={styles.inputField}>
                <Icon name='user' color='#818181' size={22} />
                <TextInput placeholder='Last Name' style={styles.input} placeholderTextColor='#818181'/>
            </View>
            <View style={styles.inputField}>
            ...
            <View style={styles.inputField}>
                <Icon name='phone' color='#818181' size={22} />
                <TextInput keyboardType='phone-pad' placeholder='Phone Number' style={styles.input} placeholderTextColor='#818181'/>
            </View>
            <View style={styles.inputField}>
                <Icon name='location-arrow' color='#818181' size={22} />
                <TextInput placeholder='Home Address' style={styles.input} placeholderTextColor='#818181'/>
            </View>
            <View style={styles.inputField}>
            ...
            <Button btn_text='Sign Up' onPress={() => navigation.replace('Login')}/>
